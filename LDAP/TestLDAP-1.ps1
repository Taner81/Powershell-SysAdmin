...
##Test LDAP Churchwood
#Test-LdapConnectivity 217.177.12.145 389 haslaict ************

##Test LDAP Elphinstone
#Test-LdapConnectivity 193.63.179.224 389 elphin.lan\techadmin ***********

##Test LDAP Elphinstone
#Test-LdapConnectivity 185.5.66.50 389 oakmeeds.local\t.sapolyo ****************


##Test LDAP CONTROL 1 [Works]
Test-LdapConnectivity 8454612-dc01 389 hasla\t.sapolyo ****** 
